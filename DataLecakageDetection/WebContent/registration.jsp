		...
		<div id="site_content">
			...
			<form action="regaction.jsp" name="ff" method="get"
				...
				<div class="form_settings">
					...
					<p>
						<span>E-Mail</span><input type="text" name="email" id="mail" placeholder='name@email.com' />
					</p>
					...
					<p>
						<span>Date Of Birth</span><input type="text" name="dob" id="dob" placeholder='mm/dd//yyyy'/>
					</p>
